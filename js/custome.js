function estimate() {
    ...
    else if (selectedService == 2 || selectedService == 10) {
        cost = 1 * words;
        cost = parseFloat(cost).toFixed(2);
        document.getElementById("cost").innerHTML = "<span style='font-size:16px;padding-bottom:7.99px;color:#252425;display:block;'>Your Price</span>" + cost + "" + "<span class='inrsym'>INR</span>";
        document.getElementById('form1').style.display = '';
    }
    else if (selectedService == 5 || selectedService == 6 || selectedService == 7) {
        cost = 2 * words;
        cost = parseFloat(cost).toFixed(2);
        document.getElementById("cost").innerHTML = "<span style='font-size:16px;padding-bottom:7.99px;color:#252425;display:block;'>Your Price</span>" + cost + "" + "<span class='inrsym'>INR</span>";
        document.getElementById('form1').style.display = '';
    ...
    else if (selectedService == 11 || selectedService == 13) {
        cost = 0.120 * words;
        cost = parseFloat(cost).toFixed(2);
        document.getElementById("cost").innerHTML = "<span style='font-size:16px;padding-bottom:7.99px;color:#252425;display:block;'>Your Price</span>" + cost + "" + "<span class='inrsym'>INR</span>";
        document.getElementById('form1').style.display = '';
